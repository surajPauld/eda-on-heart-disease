...
and preventive care are crucial in reducing the impact of cardiovascular diseases.
With the increasing availability of healthcare data, Exploratory Data Analysis (EDA)
plays a vital role in understanding patterns, trends, and relationships among health
indicators. This project focuses on performing EDA on a heart disease dataset to gain
...
variable represents the presence or absence of heart disease. These features are
...
Exploratory Data Analysis was carried out using univariate, bivariate, and multivariate
analysis techniques. Multiple visualizations were created to understand the distribution of
...
levels and abnormal blood pressure were identified as major risk factors. Correlation
